...
(
    ...
    CONSTRAINT fk_to_users_comment FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE,
    CONSTRAINT fk_to_events_comment FOREIGN KEY (event_id) REFERENCES events (id) ON DELETE CASCADE
)